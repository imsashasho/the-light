    ...
    resources: {
      ru: {
        ...
        translation: {
          ...
          field_only_letters: 'поле должно содержать только буквы',
          ...
          emailError: 'Введите корректный формат электронной почты',
        },
      },
      uk: {
        // Тексты конкретного языка
        translation: {
          ...
          field_only_letters: 'поле має містити лише літери',
          ...
          emailError: 'Введіть корректний формат пошти',
      ...
      en: {
        ...
        translation: {
          ...
          field_only_letters: 'field must consist only letters',
